...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        DownloaderTask downloaderTask = new DownloaderTask(mCallback);

		// Retrieve arguments from DownloaderTaskFragment
		// Prepare them for use with DownloaderTask.
        ArrayList<Integer> argArray = this.getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
        Integer[] args = new Integer[argArray.size()];
        args = argArray.toArray(args);

		// Start the DownloaderTask
        downloaderTask.doInBackground(args);
	}
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
        ...
        public DownloaderTask(DownloadFinishedListener listener) {
        ...
        protected String[] doInBackground(Integer... objects) {
            String[] tweets = downloadTweets(objects);
            listener.notifyDataRefreshed(tweets);
            return tweets;
        }
    }
